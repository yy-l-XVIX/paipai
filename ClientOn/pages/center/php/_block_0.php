<?php
	...
	$aUrl = array(
		...
		'sFetch'	=> sys_web_encode($aMenuToNo['pages/center/php/_block_0.php']).'&nFetch=1',
		'sHtml'	=> 'pages/center/'.$aSystem['sClientHtml'].$aSystem['nClientVer'].'/block_0.php',
	);
	#url結束
	...
	$aValue = array(
		'sBackUrl'=> sys_web_encode($aMenuToNo['pages/center/php/_block_0.php']),
	);
	...
	if ($nFetch == 1)
	{
		...
		{
			$aReturn['aData']['aData'][] = $aMemberData[$LPaData['nBUid']];
		}
		$aReturn['nStatus'] = 1;
