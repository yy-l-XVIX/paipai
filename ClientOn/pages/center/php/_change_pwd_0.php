<?php
	...
	require_once(dirname(dirname(dirname(dirname(__FILE__)))).'/inc/lang/'.$aSystem['sLang'].'/change_pwd.php');
	...
	$aJs = array(
		...
		'1'	=> 'plugins/js/center/change_pwd.js',
	);
	#js結束
	...
	#給此頁使用的url
	$aUrl   = array(
		'sAct'		=> sys_web_encode($aMenuToNo['pages/center/php/_change_pwd_0_act0.php']).'&run_page=1',
		'sHtml'		=> 'pages/center/'.$aSystem['sClientHtml'].$aSystem['nClientVer'].'/change_pwd_0.php',
	);
	#url結束
