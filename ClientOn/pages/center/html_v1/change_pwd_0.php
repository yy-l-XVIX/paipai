				...
				*/
				...
				<tr>
					...
					<td class="infDataCell2">
						<!-- 可更改 -->
						<div class="Ipt">
							<input type="password" name="sPassword" placeholder="<?php echo aCHANGE['PASSWORDRULE'];?>" required>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td class="infDataCell2">
						<!-- 可更改 -->
						<div class="Ipt">
							<input type="password" name="sPassword0" placeholder="<?php echo aCHANGE['PASSWORDRULE'];?>" required>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td class="infDataCell2">
						<!-- 可更改 -->
						<div class="Ipt">
							<input type="password" name="sPassword1" placeholder="<?php echo aCHANGE['PASSWORDRULE'];?>" required>
						</div>
					</td>
				</tr>
			</tbody>
