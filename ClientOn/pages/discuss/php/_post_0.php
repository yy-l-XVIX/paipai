<?php
	...
	#給此頁運用的js，按先後順序排列陣列
	$aJs = array(
		'0'	=> 'plugins/js/discuss/post.js',
		'1'	=> 'plugins/js/EmojiInsert.js',
		'2'	=> 'plugins/js/SnoozeKeywords.js',
		'3'	=> 'plugins/js/File.js',
	);
	#js結束
	...
	#給此頁使用的url
	$aUrl   = array(
		'sAct'	=> sys_web_encode($aMenuToNo['pages/discuss/php/_post_0_act0.php']),
		'sHtml'	=> 'pages/discuss/'.$aSystem['sClientHtml'].$aSystem['nClientVer'].'/post_0.php',
	);
	#url結束
	...
	$aUrl['sAct'] .= '&run_page=1&sJWT='.sys_jwt_encode($aValue);
