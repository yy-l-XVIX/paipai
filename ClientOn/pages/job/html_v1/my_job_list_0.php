	...
	foreach($aData as $LPnId => $LPaData)
	{
		...
		<div class="JobListBlock">
				...
				<tbody>
					<tr>
						...
						<td class="JobListInfBtnTd">
							...
							{
								?>
								<div class="JobListInfBtn active"><?php echo aJOBLIST['CLOSED'];?></div>
								<?php
							}
							else
							{
								if($sUserCurrentRole == 'staff')
								{
									...
									if($LPaData['nJoin'] == 1)
									{
										?>
										<!-- 已應徵工作時呈現 -->
										<a class="JobListInfBtn detail" href="<?php echo $LPaData['sDetailUrl'];?>"><?php echo aJOBLIST['DETAIL'];?></a>
										<?php
									}
									else
									{
										...
										else
										{
											?>
											<!-- 尚未應徵工作時呈現 -->
											<div class="JobListInfBtn JqJoin" data-jid="<?php echo $LPnId;?>"><?php echo aJOBLIST['JOIN'];?></div>
											<?php
										}
									}
								}
							...
							*/
							...
							{
								?>
								<a class="JobListInfBtn active" href="<?php echo $LPaData['sDetailUrl'];?>"><?php echo aJOBLIST['CLOSED'];?></a>
								<?php
							}
							else
							{
			...
			<div class="JobListContent">
				<div><?php echo aJOBLIST['WORKTIME'];?></div>
				<div>
			...
			<div class="JobListContent">
				<div><?php echo aJOBLIST['WORKPLACE'];?></div>
