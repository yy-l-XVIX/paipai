<?php
	...
	#給此頁使用的url
	$aUrl = array(
		'sAct'	=> sys_web_encode($aMenuToNo['pages/client_service/php/_client_service_kind_0_act0.php']),
		'sBack'	=> sys_web_encode($aMenuToNo['pages/client_service/php/_client_service_kind_0.php']),
		'sHtml'	=> 'pages/client_service/'.$aSystem['sHtml'].$aSystem['nVer'].'/client_service_kind_0_upt0.php',
	);
	#url結束
	...
	else
	{
		while($aRows = $Result->fetch(PDO::FETCH_ASSOC))
		{
			...
			$aData[$aRows['sLang']]['sName0'] = $aRows['sName0'];
		}
