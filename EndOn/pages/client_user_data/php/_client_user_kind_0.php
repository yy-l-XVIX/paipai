<?php
	...
	#給此頁使用的url
	$aUrl = array(
		'sIns'	=> sys_web_encode($aMenuToNo['pages/client_user_data/php/_client_user_kind_0_upt0.php']),
		'sDel'	=> sys_web_encode($aMenuToNo['pages/client_user_data/php/_client_user_kind_0_act0.php']).'&run_page=1',
		'sPage'	=> sys_web_encode($aMenuToNo['pages/client_user_data/php/_client_user_kind_0.php']),
		'sHtml'	=> 'pages/client_user_data/'.$aSystem['sHtml'].$aSystem['nVer'].'/client_user_kind_0.php'
	);
	#url結束
