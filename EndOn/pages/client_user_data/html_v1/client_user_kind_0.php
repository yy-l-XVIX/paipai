			...
			<table>
				<thead>
					<tr>
						...
						<th><?php echo aUSERKIND['MEMBERFREETIME'];?></th>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td class="<?php echo $aType0[$LPaDetail['nType0']]['sClass']; ?>">
								<span><?php echo $aType0[$LPaDetail['nType0']]['sText'];?></span>
							</td>
							<td>
								<span><?php echo $LPaDetail['sFreeStartTime'];?></span>
								<span>~</span>
								<span><?php echo $LPaDetail['sFreeEndTime'];?></span>
							</td>
