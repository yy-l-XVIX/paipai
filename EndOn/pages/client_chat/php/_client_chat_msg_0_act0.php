<?php
	...
	$nGid		= filter_input_int('nGid',		INPUT_REQUEST,0);# group id
	...
	$nErr = 0;
	$sMsg = '';
	$sBackUrl = sys_web_encode($aMenuToNo['pages/client_chat/php/_client_chat_msg_0.php']).'&nId='.$nGid;
	#宣告結束
