<?php
	...
	#參數接收區
	$nCid		= filter_input_int('nCid', 	INPUT_REQUEST,0);
	...
	#給此頁使用的url
	$aUrl = array(
		'sIns'	=> sys_web_encode($aMenuToNo['pages/client_job/php/_client_city_area_0_upt0.php']),
		'sDel'	=> sys_web_encode($aMenuToNo['pages/client_job/php/_client_city_area_0_act0.php']).'&run_page=1',
		'sPage'	=> sys_web_encode($aMenuToNo['pages/client_job/php/_client_city_area_0.php']),
		'sHtml'	=> 'pages/client_job/'.$aSystem['sHtml'].$aSystem['nVer'].'/client_city_area_0.php',
	);
	#url結束
	...
	while($aRows = $Result->fetch(PDO::FETCH_ASSOC))
	{
		...
		if ($aRows['nId'] == $nCid)
		{
			$aCity[$aRows['nId']]['sSelect'] = 'selected';
		}
	}
