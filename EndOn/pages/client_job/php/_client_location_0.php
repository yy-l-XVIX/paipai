<?php
	...
	#給此頁使用的url
	$aUrl = array(
		'sIns'	=> sys_web_encode($aMenuToNo['pages/client_job/php/_client_location_0_upt0.php']),
		'sDel'	=> sys_web_encode($aMenuToNo['pages/client_job/php/_client_location_0_act0.php']).'&run_page=1',
		'sPage'	=> sys_web_encode($aMenuToNo['pages/client_job/php/_client_location_0.php']),
		'sHtml'	=> 'pages/client_job/'.$aSystem['sHtml'].$aSystem['nVer'].'/client_location_0.php'
	);
	#url結束
