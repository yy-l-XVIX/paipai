<?php
	...
	#給此頁使用的url
	$aUrl = array(
		'sAct'	=> sys_web_encode($aMenuToNo['pages/client_job/php/_client_city_0_act0.php']).'&run_page=1',
		'sBack'	=> sys_web_encode($aMenuToNo['pages/client_job/php/_client_city_0.php']),
		'sHtml'	=> 'pages/client_job/'.$aSystem['sHtml'].$aSystem['nVer'].'/client_city_0_upt0.php',
	);
	#url結束
	...
	if($nId != 0)
	{
		...
		$aLocation[$aData['nLid']]['sSelect'] = 'selected';
	}
	else
	{
		$aData['sName0'] = '';
