      ...
      {
      ?>
      <div class="jumpMsgBox JqJumpMsgBox <?php echo (!empty($LPaData['sBoxClass']))?$LPaData['sBoxClass']:'';echo ($LPaData['sShow'] == 1)?'active':''; ?>" data-showmsg="<?php echo $LPnId; ?>">
            <div class="jumpMsgContainer">
                  <div class="jumpMsgInner">
                        ...
                        <div class="jumpMsgContent">
                              ...
                              {
                              ?>
                                    <div class="jumpMsgContentTxt"><?php echo $LPaData['sMsg']; ?></div>
                              <?php
                              }
                              ?>
